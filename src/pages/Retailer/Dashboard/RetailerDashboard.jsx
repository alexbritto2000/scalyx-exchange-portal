...
import ProductCatelog from '../../../assets/retailer/product-catelog.svg';
import MessageDropDown from '../../../assets/retailer/message-dropdown.svg';
import SendRFQ from '../../../assets/retailer/send-rfq.svg';
import StarIcon from '../../../assets/retailer/star.svg';
                  ...
                  <div className='ml-4 flex flex-col items-center justify-between'>
                    ...
                    <Popover placement="bottom-end">
                      <PopoverTrigger>
                        ...
                        >
                          <IoMdMore className='text-[#D1D5DB] hover:text-[#6B7280] text-[1.5rem] cursor-pointer' />
                        </Button>
                      </PopoverTrigger>
                      <PopoverContent className="p-1 min-w-[120px]">
                        <Listbox variant="flat" aria-label="Actions">
                          <ListboxItem key="product-catalog">
                            <div className='flex items-center gap-2 text-[0.82rem] text-[#6B7280]'>
                              <img src={ProductCatelog} alt="Product Catalog" />
                              Product Catalog
                            </div>
                          </ListboxItem>
                          ...
                          <ListboxItem key="message">
                            <div className='flex items-center gap-2 text-[0.82rem] text-[#6B7280]'>
                              <img src={MessageDropDown} alt="Message" />
                              Message
                            </div>
                          </ListboxItem>

                          <ListboxItem key="send-rfq">
                            <div className='flex items-center gap-2 text-[0.82rem] text-[#6B7280]'>
                              <img src={SendRFQ} alt="SendRFQ" />
                              Send RFQ
                            </div>
                          </ListboxItem>

                          <ListboxItem key="review">
                            <div className='flex items-center gap-2 text-[0.82rem] text-[#6B7280]'>
                              <img src={StarIcon} alt="Write Review" />
                              Write Review
                            </div>
                          </ListboxItem>
                        </Listbox>
