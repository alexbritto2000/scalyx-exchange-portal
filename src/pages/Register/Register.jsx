                ...
                <div className="bg-white rounded-lg shadow-md flex max-w-full py-5 px-5 gap-[5.125rem]">
                    ...
                    <div className="flex-1 flex flex-col justify-center max-w-[24.063rem] pl-16">
                            ...
                            {({ errors, touched, isSubmitting }) => (
                                <Form className="flex flex-col gap-4">
                                            ...
                                            <div>
                                                <div className="relative">
                                                    <Input
                                                        ...
                                                        classNames={{
                                                            inputWrapper: `${inputWrapperStyle} ${touched.repeatPassword && errors.repeatPassword ? 'border-red-500' : ''
                                                                }`,
                                                        }}
                                                    />
                                                    <button
                                    ...
                                    <div className="flex items-center justify-between text-sm">
                                        <label className="flex items-center cursor-pointer text-[0.75rem] text-black">
                                            ...
                                            <p>
                                                I would like to receive <span className="underline">newsletters</span> about updates via email.
                        ...
                        <div className="flex items-center my-5">
                            ...
                            <span className="mx-4 text-gray-400 text-xs">Or Register with</span>
                            <hr className="flex-1 border-gray-200" />
                        </div>
                        ...
                        <p className="text-center text-[0.82rem] mt-4 text-[#333333]">
                            ...
                            <span className="text-[#333333] text-[0.82rem] underline cursor-pointer" onClick={() => navigate('/login')}>
                                Login
                            </span>
                        </p>
                    </div>
